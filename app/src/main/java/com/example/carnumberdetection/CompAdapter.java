...
public class CompAdapter extends RecyclerView.Adapter<CompAdapter.MyViewHolder> {
    private ArrayList<com.example.carnumberdetection.Support> mList;

    public void setmList(ArrayList<com.example.carnumberdetection.Support> mList) {
        this.mList = mList;
    }
    ...
    public CompAdapter(ArrayList<com.example.carnumberdetection.Support> aList) {
        mList = aList;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, int i) {
        com.example.carnumberdetection.Support temp = mList.get(i);
