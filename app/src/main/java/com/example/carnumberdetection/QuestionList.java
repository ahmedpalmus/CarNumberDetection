...
public class QuestionList extends AppCompatActivity {
    ...
    private final String URL = Server.ip + "getquestions.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newcomp=findViewById(R.id.new_ques);
        ...
        newcomp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(QuestionList.this, NewQuestion.class);
                intent.putExtra("id", username);
                startActivity(intent);
                finish();
            }
    ...
    private void getInfos() {
        class Async extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(QuestionList.this, "please waite...", "Connecting....");
            }
